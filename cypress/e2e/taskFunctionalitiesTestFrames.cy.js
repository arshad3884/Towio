...
describe("Create, Edit, Delete and Restore Tasks", () => {
  ...
  it("Add new, View All Tasks and Completed", () => {
    //Login
    cy.visit(
      "https://my.towio.com/?company=21294#addon-com.towio.plan-64a546f0888ce"
    );
    cy.get("#email").should("exist").type("towioplan@gmail.com"); //email
    cy.get("#password").should("exist").type("123456"); //Password
